...
// OpenPGP
#define OPENPGP_START_PAGE (PAGES - 25)
#define OPENPGP_START_PAGE_ADDR	(0x08000000 + ((OPENPGP_START_PAGE)*PAGE_SIZE))
#define OPENPGP_NUM_PAGES 10
#define OPENPGP_END_PAGE (OPENPGP_START_PAGE + OPENPGP_NUM_PAGES - 1)
#define OPENPGP_END_PAGE_ADDR	(0x08000000 + ((OPENPGP_END_PAGE + 1)*PAGE_SIZE) - 1)
